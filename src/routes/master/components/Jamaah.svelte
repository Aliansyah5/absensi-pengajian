<script>
	...
	import { JamaahService, KelompokService } from '$lib/services/masterData.js';
...
<div class="content-area">
	<div class="content-header">
		<div class="header-info">
			<h1>Jamaah</h1>
			<p class="data-count">{jamaahList.length} data</p>
		</div>
		...
		<div class="modal-content" on:click|stopPropagation>
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<select bind:value={formData.jk} disabled={modalMode === 'view'}>
